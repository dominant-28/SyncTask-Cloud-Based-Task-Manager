...
export default function TaskDetails() {
  ...
  const [updateTaskAssets, { isLoading: isUpdatingAssets }] =
    useUpdateTaskAssetsMutation();
          ...
          <>
            <div className="w-full flex flex-col md:flex-row gap-5 2xl:gap-8 bg-[#272333] shadow-md px-8 py-8 overflow-y-auto">
              <div className="w-full md:w-1/2 space-y-8">
                ...
                <div className="flex items-center text-white gap-8 p-4 border-y border-teal-300">
                ...
                <div className="space-y-4 py-6">
                  <p className="text-white font-semibold text-sm">TASK TEAM</p>
                  <div className="space-y-3">
                    {task?.team?.map((m, index) => (
                      <div
                        key={index}
                        className="flex gap-4 py-2 items-center border-t border-teal-300"
                      >
                        <div
                          className={
                ...
                <div className="space-y-4 py-6">
                  <p className="text-white font -semibold text-sm">SUB_TASK</p>
          ...
          <>
            <div className="w-full flex flex-col gap-5 bg-[#272333] shadow-md px-8 py-8 overflow-y-auto">
                ...
                <div className="flex gap-3">
                  {workflowImage && (
                    <Button
                      ...
                      className="gradient-btn text-white rounded"
              ...
              {workflowImage ? (
                ...
                <div className="relative border border-teal-300 w-full h-[70vh]">
                  <div className="absolute inset-0 flex items-center justify-center bg-[#1e1b2e] text-white z-10">
                    Loading Workflow Editor...
                  </div>
                  <iframe
                    className="w-full h-full relative z-20 rounded-2xl"
                    ref={iframeRef}
                    src="https://embed.diagrams.net/?embed=1&spin=1&proto=json&saveAndExit=0&ui=dark"
                    id="drawioFrame"
                    frameBorder="0"
  ...
  rounded-md justify-between overflow-y-auto"
    >
      ...
      <div className="w-full md:w-1/3">
        <h4 className="text-white font-semibold text-lg mb-5">Add Activity</h4>
        <div className="w-full flex flex-wrap gap-5">
          ...
          <textarea
            ...
            placeholder="Type ......"
            className="bg-[#272333] w-full mt-10 border border-teal-300 outline-none p-4 rounded-md focus:ring-2 ring-blue-500"
          ></textarea>
          {isLoading ? (
            <Loading />
          ) : (
